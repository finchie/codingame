...
function sortActionsByValueDescending(actions: Action[]): void {
    actions.sort((a, b) => b.price/cost(b.delta) - a.price/cost(a.delta));
}
...
// function mostValuableOrder(orders: Action[]): Action {
